...
<body>
    <div class="container-fluid">
        ...
        <!-- Content -->
        <div class="content">
            <a href="/data_pelatihan/create" class="btn">Tambah Pelatihan</a>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/data_pelatihan/edit/<?php echo $row['id_pelatihan']; ?>" class="btn-warning">Edit</a>
                        <a href="/data_pelatihan/delete/<?php echo $row['id_pelatihan']; ?>" class="btn-danger">Delete</a>
                    </td>
                </tr>
                <?php 
                } 
