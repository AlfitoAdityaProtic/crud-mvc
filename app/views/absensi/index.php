...
<body>
 ...
 <!-- Content -->
 <div class="content">
            <a href="/absensi/create" class="btn btn-primary">Tambah Data Karyawan</a>
                ...
                <tbody>
                        ...
                        foreach ($DataAbsensi as $row): ?>
                            <tr>
                                ...
                                <td><?php echo isset($row['tanggal_dan_waktu']) ? htmlspecialchars($row['tanggal_dan_waktu']) : 'N/A'; ?></td>
                                <td><?php echo isset($row['status']) ? htmlspecialchars($row['status']) : 'N/A'; ?></td>
                                <td><?php echo isset($row['keterangan']) ? htmlspecialchars($row['keterangan']) : 'N/A'; ?></td>
                                <td>
                                    <a href="/absensi/edit/<?php echo isset($row['id_absensi']) ? $row['id_absensi'] : ''; ?>" class="btn-warning">Edit</a>
                                    <a href="/absensi/delete/<?php echo isset($row['id_absensi']) ? $row['id_absensi'] : ''; ?>" class="btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                </tbody>
