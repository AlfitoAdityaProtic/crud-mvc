    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="/pelatihan_karyawan/store" method="post">
                    <label for="id_pelatihanKaryawan">ID Pelatihan Karyawan</label>
                    <input type="number" name="id_pelatihanKaryawan" id="id_pelatihanKaryawan" class="form-control" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_pelatihan" id="id_pelatihan" class="form-control">
                            ...
                            <?php foreach ($data_pelatihan as $pelatihan) : ?>
                                <option value="<?= $pelatihan['id_pelatihan'] ?>"><?= $pelatihan['nama'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
