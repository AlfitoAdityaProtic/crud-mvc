            ...
            <div class="card-body">
                <form action="/departemen/update" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_departemen" id="nama_departemen" class="form-control" value="<?= $DataDepartemen['nama_departemen']; ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="job_desk" class="form-label">Tugas Departemen</label>
                        <input type="text" name="job_desk" id="job_desk" class="form-control" value="<?= $DataDepartemen['job_desk']; ?>" required>
                    </div>
